...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hangman2020.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "user1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "4f1e9373-1746-4cad-bcda-089ede04cc28",
                            Email = "player1@pslib.cz",
                            EmailConfirmed = true,
                            LockoutEnabled = true,
                            NormalizedEmail = "PLAYER1@PSLIB.CZ",
                            NormalizedUserName = "PLAYER1@PSLIB.CZ",
                            PasswordHash = "AQAAAAEAACcQAAAAELuuEytAk9FkD8D0+vhW/rgcbyWwl+yQwTNcoaKsPI19bSHwPJgizUYehhC+SUdO+Q==",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Hangman2020.Data.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
