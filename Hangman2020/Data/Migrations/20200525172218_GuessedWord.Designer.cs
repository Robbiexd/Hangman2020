...
namespace Hangman2020.Data.Migrations
{
    ...
    [Migration("20200525172218_GuessedWord")]
    partial class GuessedWord
    {
            ...
            modelBuilder.Entity("Hangman2020.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "user1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f3b772c3-b723-4968-8662-aa5cbfa28705",
                            Email = "player1@pslib.cz",
                            EmailConfirmed = true,
                            LockoutEnabled = true,
                            NormalizedEmail = "PLAYER1@PSLIB.CZ",
                            NormalizedUserName = "PLAYER1@PSLIB.CZ",
                            PasswordHash = "AQAAAAEAACcQAAAAEBMs0l7WttotOERAS8wCBlmXdlysSqQVEJvRCZ8PH4/nT1PUyr/Y5Q66DTvB2Yeoyg==",
